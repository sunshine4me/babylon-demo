import{ag as e}from"./index-DHuikXXi.js";const o="prePassDeclaration",S=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const i="oitDeclaration",g=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=g);const t="decalFragmentDeclaration",w=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=w);const a="lightFragmentDeclaration",D=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=D);const r="lightUboDeclaration",X=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=X);const s="samplerFragmentDeclaration",x=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=x);const n="shadowsFragmentFunctions",L=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=C);const d="bumpFragmentMainFunctions",E=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);const f="bumpFragmentFunctions",T=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=T);const h="reflectionFunction",I=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=I);const c="decalFragment",A=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=A);const v="bumpFragment",P=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=F);const u="lightFragment",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const m="oitFragment",M=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
