import{ag as e}from"./index-dzV0rMYg.js";import"./oitFragment-DoC17AU6.js";import"./harmonicsFunctions-Bf5WWhQO.js";import"./mainUVVaryingDeclaration-DVjLSDpY.js";import"./logDepthFragment-C4M26qz5.js";import"./fogFragment-B0DWsvhZ.js";import"./logDepthDeclaration-CpvMe-Po.js";import"./helperFunctions-zyy4fTgf.js";const r="pbrFragmentExtraDeclaration",y=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=X);const d="hdrFilteringFunctions",k=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=k);const s="pbrDirectLightingFunctions",z=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=z);const E="pbrIBLFunctions",K=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=K);const S="pbrBlockAlbedoOpacity",$=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=$);const m="pbrBlockReflectivity",q=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=q);const u="pbrBlockAmbientOcclusion",Z=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=Z);const R="pbrBlockAlphaFresnel",j=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=j);const v="pbrBlockAnisotropic",J=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=J);const C="pbrBlockReflection",Q=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Q);const p="pbrBlockSheen",ee=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ee);const A="pbrBlockClearcoat",ie=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=ie);const I="pbrBlockIridescence",re=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=re);const N="pbrBlockSubSurface",ae=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=ae);const O="pbrBlockNormalGeometric",ne=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ne);const L="pbrBlockNormalFinal",fe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=fe);const T="pbrBlockLightmapInit",te=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=te);const _="pbrBlockGeometryInfo",oe=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=oe);const D="pbrBlockReflectance0",ce=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=ce);const g="pbrBlockReflectance",le=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=le);const M="pbrBlockDirectLighting",de=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=de);const h="pbrBlockFinalLitComponents",se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=se);const F="pbrBlockFinalUnlitComponents",Ee=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=Ee);const P="pbrBlockFinalColorComposition",Se=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=Se);const U="pbrBlockImageProcessing",me=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=me);const b="pbrBlockPrePass",ue=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=ue);const B="pbrDebug",Re=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=Re);const i="pbrPixelShader",G=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=G);const Te={name:i,shader:G};export{Te as pbrPixelShaderWGSL};
