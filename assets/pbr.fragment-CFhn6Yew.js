import{ag as e}from"./index-dzV0rMYg.js";import"./oitFragment-CDP9dXtp.js";import"./harmonicsFunctions-hsSRHF8D.js";import"./mainUVVaryingDeclaration-CdpgIbpK.js";import"./logDepthFragment-DCdqINn7.js";import"./logDepthDeclaration-Cy8CJt-f.js";import"./fogFragment-CG6k5SyA.js";import"./helperFunctions-Qq87jKLC.js";const n="pbrFragmentDeclaration",V=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=V);const a="pbrFragmentExtraDeclaration",H=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=H);const o="samplerFragmentAlternateDeclaration",x=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=x);const r="pbrFragmentSamplersDeclaration",W=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=W);const t="subSurfaceScatteringFunctions",X=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=X);const f="importanceSampling",Y=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=Y);const c="pbrHelperFunctions",k=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=k);const l="pbrDirectLightingSetupFunctions",w=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=w);const d="pbrDirectLightingFalloffFunctions",z=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=z);const s="hdrFilteringFunctions",K=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=K);const E="pbrDirectLightingFunctions",$=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=$);const R="pbrIBLFunctions",q=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=q);const u="pbrBlockAlbedoOpacity",Z=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Z);const C="pbrBlockReflectivity",J=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=J);const S="pbrBlockAmbientOcclusion",j=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=j);const A="pbrBlockAlphaFresnel",Q=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Q);const m="pbrBlockAnisotropic",ee=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ee);const I="pbrBlockReflection",ie=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ie);const v="pbrBlockSheen",ne=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ne);const N="pbrBlockClearcoat",ae=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ae);const O="pbrBlockIridescence",oe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=oe);const T="pbrBlockSubSurface",re=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);const L="pbrBlockNormalGeometric",te=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=te);const p="pbrBlockNormalFinal",fe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=fe);const g="pbrBlockLightmapInit",ce=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=ce);const _="pbrBlockGeometryInfo",le=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=le);const D="pbrBlockReflectance0",de=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=de);const M="pbrBlockReflectance",se=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=se);const h="pbrBlockDirectLighting",Ee=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Ee);const F="pbrBlockFinalLitComponents",Re=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Re);const P="pbrBlockFinalUnlitComponents",ue=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ue);const U="pbrBlockFinalColorComposition",Ce=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Ce);const b="pbrBlockImageProcessing",Se=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Se);const B="pbrBlockPrePass",Ae=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ae);const G="pbrDebug",me=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=me);const i="pbrPixelShader",y=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=y);const _e={name:i,shader:y};export{_e as pbrPixelShader};
